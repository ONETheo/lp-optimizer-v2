...
class DataLoader:
    ...
    def load_historical_data(
        ...
        # --- 4. Interpolation (Consider moving this to BacktestEngine or a dedicated preprocessor) ---
        # If we decide to interpolate here:
        ...
        if interpolated_count > 0:
             logger.info(f"Interpolated {interpolated_count} missing data points (using linear method) for {pool_address}.")
